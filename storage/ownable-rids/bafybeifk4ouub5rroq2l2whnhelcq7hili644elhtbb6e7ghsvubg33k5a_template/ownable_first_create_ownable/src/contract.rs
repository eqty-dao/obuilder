...
const CONTRACT_NAME: &str = "crates.io:ownable_first_create_ownable";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("first create ownable".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("first create ownable that has been build".to_string()),
        name: Some("first create ownable".to_string()),
