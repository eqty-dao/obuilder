...
const CONTRACT_NAME: &str = "crates.io:ownable_demo_ownable";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("Demo Ownable".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("first demo create ownable".to_string()),
        name: Some("Demo Ownable".to_string()),
