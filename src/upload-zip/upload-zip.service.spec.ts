...
describe('UploadZipService', () => {
  ...
  // REMOVED: templateCost tests - logic now delegated to OwnableBuilderService and tested there
  ...
  // REMOVED: store tests - method has complex orchestration that is better tested via integration tests
  // The delegated methods (readOwnableDataFromZip, validation, etc) are unit tested in their respective services
  // ============================================
