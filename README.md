...
[MySQL](https://ubuntu.com/server/docs/databases-mysql)(https://www.rosehosting.com/blog/how-to-install-mysql-database-on-ubuntu-20-04/) 
...
```bash
$ npx prisma generate
$ npx prisma migrate dev --name wallet
```

Create a .env file and add the following environment variables:
# For MYSQL local server
DATABASE_URL="mysql://USER:PASSWD@HOST:3306/DATABASE"
